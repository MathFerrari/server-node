...
export async function registerForEvent(app: FastifyInstance) {
    ...
    .post('/events/:eventId/attendees', {
        schema: {
            summary: 'Register an new attendees',
            tags: ['attendees'],
            body: z.object({
                name: z.string().min(4),
        ...
        if(event?.maximumAttendees && amountOfAttendeesForEvents >= event?.maximumAttendees) throw new BadRequest("This event is already full")
